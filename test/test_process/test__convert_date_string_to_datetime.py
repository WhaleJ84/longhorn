...
class ConvertDateStringToDatetimeTestCase(ProcessFunctionsTestCase):
    def test_convert_date_string_to_datetime_returns_datetime_with_milliseconds_on_regex_match(
        self,
    ):
        self.assertEqual(
    ...
    def test_convert_date_string_to_datetime_returns_datetime_without_milliseconds_on_regex_match(
        self,
    ):
        self.assertEqual(
    ...
    def test_convert_date_string_to_datetime_returns_none_on_bad_format(self):
        self.assertIsNone(
            self.process._convert_date_string_to_datetime("01/01/1970 00:00:00")
        )
